...
export BASE_MODEL='/AI4M/users/fanyyang/code/github/LLaMA-Factory-main/saves/LeanToolCoT_qwen2.5_7B_sft/full/sft_distill_think'
...
export EXPERIMENT_NAME="qwen_25_7b_leancot_distill_think_debug_nan_$(date +%Y%m%d_%H%M%S)"

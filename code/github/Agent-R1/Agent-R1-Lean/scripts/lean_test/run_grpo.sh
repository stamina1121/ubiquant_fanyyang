...
# export BASE_MODEL='/AI4M/users/fanyyang/code/github/LLaMA-Factory-main/saves/LeanToolCoT_qwen2.5_7B_sft/full/sft_distill'
# export BASE_MODEL='/AI4M/llm/Qwen3-8B'
export BASE_MODEL='/AI4M/users/fanyyang/code/github/LLaMA-Factory-main/saves/qwen3_8B_distill/full/sft_distill_think'
export BASE_MODEL='/AI4M/llm/Qwen2.5-14B-Instruct'
#export BASE_MODEL='/AI4M/users/fanyyang/code/github/LLaMA-Factory-main/saves/qwen3_8B_distill/full/sft_distill_think'
# export BASE_MODEL='/AI4M/users/qzh/dotLLM/LLaMA-Factory/saves/LeanToolCoT_qwen2.5_7B_sft'
# export BASE_MODEL='/AI4M/users/fanyyang/code/github/LLaMA-Factory-main/saves/qwen2.5-7B-it/full/sft'
# export BASE_MODEL='/AI4M/llm/Qwen2.5-14B-Instruct'
export PROJECT_NAME='Agent-R1-Lean'
export EXPERIMENT_NAME="qwen_25_14b_$(date +%Y%m%d_%H%M%S)"
#export EXPERIMENT_NAME="qwen_25_7b_leancot_debug_nan_$(date +%Y%m%d_%H%M%S)"
...
nohup python3 -u -m agent_r1.src.main_agent \
    ...
    tool.max_turns=5 \
    tool.env='lean_full' $@ >> "${LOG_FILE}" 2>&1

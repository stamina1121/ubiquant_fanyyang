...
BASE_MODEL=/AI4M/users/fanyyang/code/github/LLaMA-Factory-main/saves/LeanToolCoT_qwen2.5_14B_sft/full/sft_distill_think
PROJECT_NAME="Agent-R1-Lean"
EXPERIMENT_NAME="qwen_25_14b_leancot_distill_think_debug_nan_$(date +%Y%m%d_%H%M%S)"
